...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/tracks-style.css') }}">
            ...
            <div class="desktop">
                ...
                <div class="links">
                    <ul>
                        ...
                        <li class="active"><a href="#"  class="active">المسارات التعليمية</a></li>
            ...
            <div class="mobile">
                <div class="links">
                    ...
                    <ul>
                        ...
                        <li><a href="about.html">نبذه عنا</a></li>
                        <li><a href="courses.html">الدورات</a></li>
                        <li><a href="tracks.html"  class="active">المسارات التعليمية</a></li>
                        <li><a href="team.html">المدربين</a></li>
            ...
            <div class="tracks-content">
                ...
                <h1>اكتشف اشهر الدورات التي نقدمها لك</h1>
                    ...
                    <div class="tracks2-details">
                        @foreach($diploma as $track)

                        <div class="track">
                            <a href="{{ route('roadmap.index', $track->id) }}" target="_blank"><img src="{{ asset($track->image) }}" alt=""></a>
                            <h3>{{$track->name}}</h3>
